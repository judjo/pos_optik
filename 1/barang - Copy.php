							...
							<div class="form-group col-md-6">
								<label>Harga Modal</label>
									<div class="input-group date">
										...
										<input name="harga_pokok" type="text" class="form-control" value="<?php echo $harga_pokok; ?>" 
													onblur="if (value == '') {value = '0'}" 
													onfocus="if (value == '0') {value =''}" required>
									</div>
							</div>							
							<div class="form-group col-md-6">
								<label>Harga Supplier</label>
									<div class="input-group date">
										...
										<input name="harga_distributor" type="text" class="form-control" value="<?php echo $harga_distributor; ?>" 
													onblur="if (value == '') {value = '0'}" 
													onfocus="if (value == '0') {value =''}" required>
									</div>
							</div>
							...
							<div class="form-group col-md-6">
								<label>Warning</label>
									<div class="input-group date">
										...
										<input name="warning" type="text" class="form-control" placeholder="" required>
									</div>
							</div>
							<div class="form-group col-md-6">
