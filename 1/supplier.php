  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="supplier_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group col-md-6">
								<label>Kode Supplier</label>
									<div class="input-group">
										...
										<input name="kode_supplier" type="text" class="form-control" placeholder="" value="<?php echo $newID;?>" required />
									</div>
							</div>
							<div class="form-group">
								<label>Nama Supplier</label>
									<div class="input-group">
										...
										<input name="nama_supplier" type="text" class="form-control" placeholder="" required />
									</div>
							</div>
							<div class="form-group col-md-6">
								<label>No Telp</label>
							...
							<div class="form-group">
								<label>Alamat</label>
									<div class="input-group date">
										...
										<input name="alamat_lengkap" type="text" class="form-control" placeholder="" required>
									</div>
							</div>	
							<div class="form-group col-md-6">
								<label>sales</label>
									<div class="input-group date">
										...
										<input name="sales" type="text" class="form-control" placeholder="" required>
									</div>
							</div>							
							<div class="form-group col-md-6">
		...
		<!-- Modal Popup Edit -->
		<div id="ModalEditSupplier" class="modal fade" tabindex="-1" role="dialog"></div>
