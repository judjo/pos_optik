      ...
      <aside class="main-sidebar">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="kategori.php"><i class="fa fa-circle-o"></i> Kategori Barang</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>SIFO OPTIK</b></center></h1>
					<center><h2><b>SIFO OPTIK Developer Copyright &copy;  <?php echo date ('Y') ?></b></h2></center>
                </div><!-- /.box-header -->
                <div class="box-body">
